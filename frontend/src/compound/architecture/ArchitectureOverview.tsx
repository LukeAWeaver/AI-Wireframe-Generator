...
export const ArchitectureOverview = () => (
  <Box sx={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
    ...
    <Typography sx={{ maxWidth: 900, m: '16px auto 0', color: '#ccc', fontSize: '1.1rem', textAlign: 'center' }}>
    ...
    <Typography sx={{ maxWidth: 900, m: '24px auto 0', color: '#ccc', fontSize: '1.1rem', textAlign: 'center' }}>
