...
export const HomeContent = () => (
  ...
  <Typography>This portfolio is also hosting a Wireframe Generator side project that I am working on so that I can keep my skills up while developing something interesting.</Typography>
  </Stack>
); 