            ...
            {projects.map((project, idx) => (
              <Box
                ...
                sx={{
                  ...
                  width: { xs: idx === selectedIndex ? '100%' : '80%', md: idx === selectedIndex ? '85%' : '60%' },
                  minWidth: { xs: idx === selectedIndex ? '100%' : '80%', md: idx === selectedIndex ? '85%' : '60%' },
                  maxWidth: { xs: idx === selectedIndex ? '100%' : '80%', md: idx === selectedIndex ? '85%' : '60%' },
                  minHeight: '100%',
